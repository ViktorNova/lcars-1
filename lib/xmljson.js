/**
 *	@package		XML<->JSON function collection
 * 
 *	@author			Stefan Goessner <goessner.net>
 *	@license		Creative Commons GNU LGPL License, http://creativecommons.org/licenses/LGPL/2.1/
 *	@created		2006
 *	@version		0.9
 *	@copyright		2008 dragon-projects.net <info@dragon-projects.net>

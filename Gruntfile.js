...
module.exports = function(grunt){
	grunt.initConfig({
		...
		less	: {
			debug	: {
				files	: {
					'build/css/base.css'	: 'src/css/base.less',
					'build/css/panels.css'	: 'src/css/panels.less',
					'build/css/modules.css'	: 'src/css/modules.less',
					'build/css/screens.css'	: 'src/css/screens.less'
				}
			},
			release	: {
				options	: {
				...
				files	: {
					'build/css/lcars.css'		: 'src/css/**/*.less'
				}
			}
		},
		...
		uglify	: {
			release	: {
				files	: {
					'build/js/lcars.min.js': 'build/js/lcars.js'
				}
			}
		},
